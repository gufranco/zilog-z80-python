...
class LoadTest(unittest.TestCase):
    def test_an_immediate_load_puts_the_byte_in_the_register(self):
    ...
    def test_a_register_to_register_load_copies_it(self):
    ...
    def test_a_load_through_a_pair_reads_where_it_points(self):
    ...
    def test_a_store_through_a_pair_writes_where_it_points(self):
    ...
    def test_a_wide_immediate_load_takes_two_bytes_low_first(self):
    ...
    def test_a_load_that_names_the_memory_at_hl_is_not_a_register(self):
...
class ArithmeticTest(unittest.TestCase):
    ...
    def test_an_add_sets_the_half_carry_from_the_low_nibble(self):
    ...
    def test_an_add_reports_overflow_when_the_sign_is_wrong(self):
    ...
    def test_an_add_clears_the_subtract_flag(self):
    ...
    def test_a_subtract_sets_it(self):
    ...
    def test_a_compare_takes_its_hidden_bits_from_the_operand(self):
    ...
    def test_a_subtract_takes_them_from_the_result(self):
...
class LogicTest(unittest.TestCase):
    def test_an_and_sets_the_half_carry_and_clears_the_carry(self):
    ...
    def test_an_or_clears_both(self):
    ...
    def test_a_logical_operation_reports_parity_rather_than_overflow(self):
...
class ExchangeTest(unittest.TestCase):
    def test_the_main_set_can_be_swapped_wholesale(self):
    ...
    def test_the_accumulator_has_its_own_swap(self):
    ...
    def test_the_two_working_pairs_can_be_swapped_with_each_other(self):
...
class ControlTest(unittest.TestCase):
    def test_a_jump_goes_where_it_says(self):
    ...
    def test_a_call_pushes_the_address_after_it(self):
    ...
    def test_a_return_goes_back_to_it(self):
    ...
    def test_a_relative_jump_counts_from_the_instruction_after_it(self):
    ...
    def test_a_relative_jump_backwards_is_signed(self):
    ...
    def test_a_conditional_jump_not_taken_costs_only_its_operand(self):
    ...
    def test_a_restart_goes_to_its_fixed_address(self):
        cpu, _ = machine([0xFF])
...
class RefreshTest(unittest.TestCase):
    def test_every_instruction_advances_the_refresh_counter(self):
    ...
    def test_a_prefixed_instruction_advances_it_twice(self):
...
class ResetTest(unittest.TestCase):
    def test_a_reset_puts_the_program_counter_at_the_bottom(self):
        cpu = core.Cpu(SparseMemory(seed=1), Ports(seed=1))

        self.assertEqual(cpu.registers.pc, 0x0000)

    def test_a_reset_leaves_the_working_registers_holding_what_they_held(self):
